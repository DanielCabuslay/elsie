<aside id="about-dialog" class="mdc-dialog" role="alertdialog">
  <div class="mdc-dialog__surface">
    ...
    <section class="mdc-dialog__body">
      Elsie is a Material Design MyAnimeList Web Client. Users can browse their anime list and access anime pages on MyAnimeList. Additional data is also pulled from AniList when available, such as upcoming episode times (local to Japan) and Twitter hashtags for shows.
    </section>

...
foreach($data->entry as $a) {
    echo '<li class="mdc-list-item search_result_item">';
    echo '<img class="mdc-list-item__start-detail search_result_thumb" src="' . $a->image . '">';
    echo '<span class="mdc-list-item__text">' . $a->title;
    echo '<span class="mdc-list-item__text__secondary">(' . $a->type . ', ' . substr($a->start_date, 0, 4) . ')</span>';
